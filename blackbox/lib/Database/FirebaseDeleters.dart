...
class FirebaseDeleters {
  ...
  static Future<bool> cleanGroups() async {
    ...
    /// This list will contain all queries and will get all documents to be deleted
    List<String> failedGroups = List<String>();
    ...
    Query nameDebug = groupsRef.where('name', isEqualTo: 'debug');
