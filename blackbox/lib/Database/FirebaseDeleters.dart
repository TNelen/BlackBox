...
class FirebaseDeleters {
  ...
  static Future< bool > deleteGroup(GroupData group) async {
    ...
    try {
      ...
      print("Something went wrong while deleting a group");
      print(exception);
      return false;
    }
  ...
  static Future< bool > deleteQuestion(Question question) async {
    ...
    try {
      ...
      print("Something went wrong while deleting a question");
      print(exception);
      return false;
    }
  }
  ...
  static Future< bool > deleteUser(UserData user) async {
    ...
    try {
      ...
      print("Something went wrong while deleting a user");
      print(exception);
      return false;
    }
  ...
  static Future< bool > cleanGroups() async {
    ...
    try {
      ...
      print("Something went wrong while cleaning the groups");
      print(exception);
      return false;
    }
  }
