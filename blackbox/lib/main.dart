...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final startButton = HeadShake(
      preferences: AnimationPreferences(duration: Duration(milliseconds: 750), offset: Duration(seconds: 2)),
      child: Card(
        //elevation: 5.0,
              ...
              Column(
                ...
                children: [
                  Column(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
                    ...
                    Text(
                      "BlackBox",
                      style: TextStyle(color: Colors.white, fontFamily: "atarian", fontSize: Constants.titleFontSize, fontWeight: FontWeight.w300),
                    ),
                    SizedBox(
                      height: 10,
                    ),
