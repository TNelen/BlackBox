...
extension Localization on String {
  static var _t = Translations("en") +
      ...
      } +
      {
        ...
        "nl":
            "Maak een neiuw spel, en nodig je vrienden uit door de group code te delen",
      } +
      {
        "en": "Join a game with the 5 character group code",
        "nl":
            "Speel mee met een spel door de groupcode van 5 karakters in te vullen",
      } +
      {
        "en":
      ...
      } +
      {
        ...
        "nl":
            "De spel starter kan instellen of je al dan niet op jezelf kan stemmen",
      } +
      {
        "en":
            "These settings are set in the beginning of the game and cannot be changed during the game",
        "nl":
            "Deze instellingen worden ingesteld bij het begin van het spel en kunnen niet meer veranderd worden tijdens het spel.",
      } +
      {
        "en": "",
        "nl": "",
