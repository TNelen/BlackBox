...
class PassScreen extends StatefulWidget {
  ...
  PassScreen(Database db, GroupData groupData, String code, Map<UserData, int> playerVotes ) {
    this._database = db;
  ...
  @override
  _PassScreenState createState() => new _PassScreenState(_database, groupData, code, playerVotes);
}
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 5),
                              Text(
                                "Long press to go to results when all players have voted",
                                textAlign: TextAlign.center,
                                style: new TextStyle(color: Constants.iLight, fontSize: Constants.smallFontSize, fontWeight: FontWeight.bold),
                              ),
                              SizedBox(height: 5),
